...
<div class="mx-auto max-w-3xl space-y-6">
    <div>
        ...
        <p class="mt-1 text-sm text-gray-600">Create a new supplier record for coal procurement.</p>
    </div>
    ...
    <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
        ...
        <form action="{{ route('suppliers.store') }}" method="POST" class="space-y-5">
            ...
            <div>
                ...
                <input type="text" name="supplier_code" id="supplier_code" value="{{ old('supplier_code') }}" class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-gray-900 focus:ring-gray-900 @error('supplier_code') border-red-500 @enderror" placeholder="SUP-001" required>
            ...
            <div>
                ...
                <input type="text" name="name" id="name" value="{{ old('name') }}" class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-gray-900 focus:ring-gray-900 @error('name') border-red-500 @enderror" placeholder="PT Bara Energi Nusantara" required>
            ...
            <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                ...
                <div>
                    ...
                    <input type="email" name="email" id="email" value="{{ old('email') }}" class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-gray-900 focus:ring-gray-900 @error('email') border-red-500 @enderror" placeholder="supplier@example.com">
            ...
            <div>
                ...
                <textarea name="address" id="address" rows="4" class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-gray-900 focus:ring-gray-900 @error('address') border-red-500 @enderror" placeholder="Supplier address">{{ old('address') }}</textarea>
