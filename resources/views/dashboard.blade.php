    ...
    <div class="print-card rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
        <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div>
                ...
                <p class="mt-3 text-xs font-medium text-gray-500">Generated at {{ now()->format('d M Y H:i') }}</p>
            </div>
            <div class="no-print grid grid-cols-2 gap-3 text-sm sm:grid-cols-4 lg:w-[520px]">
                ...
                <a href="{{ route('reports.stock-movements') }}" class="rounded-xl bg-gray-50 p-4 text-center font-semibold text-gray-800 ring-1 ring-gray-100 hover:bg-gray-100">Stock Report</a>
                <a href="{{ route('reports.shipments') }}" class="rounded-xl bg-gray-50 p-4 text-center font-semibold text-gray-800 ring-1 ring-gray-100 hover:bg-gray-100">Shipment Report</a>
            </div>
        </div>
    </div>

    <div class="grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-6">
        <div class="print-card rounded-2xl border border-gray-200 bg-white p-5 shadow-sm xl:col-span-1">
    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
        <div class="print-card rounded-2xl border border-gray-200 bg-white p-6 shadow-sm lg:col-span-2">
            ...
            <div class="grid grid-cols-2 gap-4 md:grid-cols-4">
                <div class="print-card rounded-xl border border-gray-100 bg-gray-50 p-4"><p class="text-xs text-gray-500">Suppliers</p><p class="mt-2 text-2xl font-bold">{{ number_format($totalSuppliers) }}</p></div>
                <div class="print-card rounded-xl border border-gray-100 bg-gray-50 p-4"><p class="text-xs text-gray-500">Customers</p><p class="mt-2 text-2xl font-bold">{{ number_format($totalCustomers) }}</p></div>
                <div class="print-card rounded-xl border border-gray-100 bg-gray-50 p-4"><p class="text-xs text-gray-500">Products</p><p class="mt-2 text-2xl font-bold">{{ number_format($totalProducts) }}</p></div>
                <div class="print-card rounded-xl border border-gray-100 bg-gray-50 p-4"><p class="text-xs text-gray-500">Total Stock</p><p class="mt-2 text-2xl font-bold">{{ number_format($totalStockCapacity, 2) }}</p></div>
                <div class="print-card rounded-xl border border-gray-100 bg-gray-50 p-4"><p class="text-xs text-gray-500">Purchase Orders</p><p class="mt-2 text-2xl font-bold">{{ number_format($totalPurchaseOrders) }}</p></div>
                <div class="print-card rounded-xl border border-gray-100 bg-gray-50 p-4"><p class="text-xs text-gray-500">Sales Orders</p><p class="mt-2 text-2xl font-bold">{{ number_format($totalSalesOrders) }}</p></div>
                <div class="print-card rounded-xl border border-gray-100 bg-gray-50 p-4"><p class="text-xs text-gray-500">Shipments</p><p class="mt-2 text-2xl font-bold">{{ number_format($totalShipments) }}</p></div>
                <div class="print-card rounded-xl border border-gray-100 bg-gray-50 p-4"><p class="text-xs text-gray-500">Stock Movements</p><p class="mt-2 text-2xl font-bold">{{ number_format($totalStockMovements) }}</p></div>
            </div>
        </div>
        ...
        <div class="print-card rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
            ...
            <div class="space-y-3">
                @forelse ($shipmentStatuses as $item)
                    <div class="print-card flex items-center justify-between rounded-xl border border-gray-100 bg-gray-50 px-4 py-3">
        ...
        <div class="print-card rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
            ...
            <div class="space-y-3">
                @forelse ($lowStockProducts as $product)
                    <div class="print-card rounded-xl border border-red-200 bg-red-50 p-4 text-sm">
